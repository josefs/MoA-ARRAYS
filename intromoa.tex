...
\subsection{Applying the Psi Correspondence Theorem\cite{jen94}]
We now want to {\em transform} the DNF to a {\em Generic} Operational Normal Form (ONF) or way 
to {\em build the code}. 
