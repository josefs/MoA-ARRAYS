...
An initial observation is that MoA and Pull arrays where developed for
different purposes and that can be seen already by looking at the
notation. Mathematics of arrays have first and foremost been used for
...
Pull arrays on the other hand where conveived in the context of a
